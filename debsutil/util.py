...
# from Tony.Suraki
"""Simple function to convert a 32 bit integer
   timestamp into days, hours, minutes
   and seconds
"""
def convertSeconds(seconds):
    # variables to calculate number of seconds
    # in days from given input and then using
    # remainder as input for the hour and so on
    day = seconds // (24 * 3600)
    ...
    time = rem % (1 * 60)
    seconds = time
    time = "d:h:m:s ==> %d:%d:%d:%d" % (day, hour, minutes, seconds)
    return time
def main():
